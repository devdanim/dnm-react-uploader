  ...
  function (_React$Component) {
    ...
    _createClass(Uploader, [{
      ...
      value: function render() {
        ...
        }, this.props.fetching ? this.props.catalogue.loading : "".concat(this.props.catalogue.click, "/").concat(this.props.catalogue.drop).concat(this.props.withURLInput ? "/".concat(this.props.catalogue.typeURL) : '')), withControls === true && React.createElement(React.Fragment, null, React.createElement("div", {
